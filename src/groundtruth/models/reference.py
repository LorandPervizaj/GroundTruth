...
class Street(Base, TimestampMixin):
    ...
    __table_args__ = (UniqueConstraint("neighborhood_id", "slug", name="uq_street_neighborhood_slug"),)
...
class Complex(Base, TimestampMixin):
    ...
    __table_args__ = (UniqueConstraint("neighborhood_id", "slug", name="uq_complex_neighborhood_slug"),)
